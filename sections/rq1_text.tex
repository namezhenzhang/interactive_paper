...
\begin{figure}[t]
  ...
  \caption{ROC on the calibration split. The final-layer probe and both
  $\ptrue$ readouts separate cleanly from the best decode scalar;
  $\ptrue$-post leads but requires a fully drafted answer, which a live
  voice loop cannot wait for. AUC values: Table~\ref{tab:rq1}.}
  \label{fig:roc}
\end{figure}
