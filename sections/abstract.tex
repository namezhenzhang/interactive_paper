...
Finally we close the loop live: in full streaming duplex sessions, an
...
(.400 $\to$ .633 at 55\% escalation), with the gap to offline operation
decomposed into measured audio, streaming, and speech-channel taxes.
\end{abstract}
