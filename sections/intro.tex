...
\item \textbf{The loop closes live (\S\ref{sec:live}).} In full streaming
  ...
  climbs monotonically from its honest streaming floor (.400 $\to$ .633 at
  55\% escalation), with the gap to offline operation itemized into
  measured audio, streaming, and speech-channel taxes.
\end{enumerate}
